...
<div class="wrapper">
  ...
  <div id="content-wrap">
    ...
    <?php else: ?>
      ...
      <?php if ($is_front && ($page["home_column_1"] || $page["home_column_2"] || $page["home_column_3"] || $page["home_column_4"] || $page["home_column_5"] || $page["home_column_6"])): ?>
      <!-- Home page with six responsive blocks. -->
      ...
      <?php else: ?>
        <!-- Home page with a node, node list or view. -->
